    ...
    'schemas' => [
        'default' => [
            'query' => [
                ...
                \App\GraphQL\Query\BulletinAnalyseQuery::class,
                \App\GraphQL\Query\RdvQuery::class,
                ...
                \App\GraphQL\Query\PlanningQuery::class,
                ...
                \App\GraphQL\Query\SuiviQuery::class,
                ...
                \App\GraphQL\Query\NotificationQuery::class,
                ...
                \App\GraphQL\Query\PatientMedicalQuery::class,
                \App\GraphQL\Query\ServicePaginatedQuery::class,
                \App\GraphQL\Query\CertificatMedicalQuery::class,
                \App\GraphQL\Query\ServiceQuery::class,
                \App\GraphQL\Query\ProduitQuery::class,
                \App\GraphQL\Query\PatientSiteQuery::class,
                \App\GraphQL\Query\ProduitPaginatedQuery::class,
            ],
            'mutation' => [
                // ExampleMutation::class,
            ],
            // The types only available in this schemaRéponds uniquement en français.
            'types' => [
                //\App\GraphQL\Type\HoraireRdvType::class,
                \App\GraphQL\Type\TaxeType::class,
                \App\GraphQL\Type\CreneauType::class,
                \App\GraphQL\Type\BulletinAnalyseType::class,
                \App\GraphQL\Type\RdvType::class,
                \App\GraphQL\Type\CertificatMedicalType::class,
                \App\GraphQL\Type\PatientSiteType::class,
                \App\GraphQL\Type\ElementBulletinAnalyseType::class,
                ...
                \App\GraphQL\Type\PlanningType::class,
                \App\GraphQL\Type\ClientType::class,
                \App\GraphQL\Type\VenteProduitType::class,
                \App\GraphQL\Type\PatientMedicalType::class,
                ...
                \App\GraphQL\Type\SuiviType::class,
