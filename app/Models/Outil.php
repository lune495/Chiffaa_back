...
class Outil extends Model
{
    public static $queries = array(
        ...
        "plannings"                  => " id,date_planning,heure_debut,heure_fin,medecin{id,nom}",
        "patient_sites"              => " id,prenom,nom,telephone,adresse,rdvs{id,planning{id,date_planning,jour,heure_debut,heure_fin},date,heure,status}",
        "rdvs"                       => " id,user{name,email,telephone},status,creneau{id,date,heure_debut,heure_fin,disponible}",
        "depenses"                   => " id,nom,bc,montant,user{id,name},created_at",
