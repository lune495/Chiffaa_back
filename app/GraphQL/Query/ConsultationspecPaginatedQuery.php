...
use \App\Models\Consultationspec;

class ConsultationspecPaginatedQuery extends Query
{
    protected $attributes = [
        'name'              => 'consultationspecspaginated',
        'description'       => ''
    ];

    public function type():type
    {
        return GraphQL::type('consultationspecspaginated');
    }
