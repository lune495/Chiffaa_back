...
class CaisseController extends Controller
{
    ...
    public function generatePDF2()
    {
            ...
            if ($count === 0) {
                ...
                // })
                // ->where('created_at', '<=', now())
                ->whereBetween('created_at', ["2023-01-12 14:15:05", "2023-01-12 15:26:35"])
                // ->where('statut_pharma','=',false)
                ->groupBy('designation')
                ->orderBy('designation')
                ->get();
                ...
                // ->first();
                ->orderBy('id', 'asc')
                ->whereBetween('date_fermeture', ["2023-01-12 14:15:05", "2023-01-12 15:26:35"])
                ->get();
                ...
                $results['data'] = $data;
                $results['depenses'] = $depenses;
                $results['derniere_date_fermeture'] = "2023-01-12 14:15:05";
                $results['current_date'] = "2023-01-12 15:26:35";
                    //dd($results);
            }
