            ...
            <section  style="margin-top : 30px">
                <table>
                    ...
                    <!-- <tr>
                        ...
                        {{$montant = 0}}
                        @foreach($element_consultations as $element_consultation )
                            <tr>
                                <td style="padding-left: 15px;">{{$element_consultation["type_consultation"]["nom"] ? $element_consultation["type_consultation"]["nom"] : "" }}</td>
                                <td style="padding-left: 15px;">{{$element_consultation["type_consultation"]["prix"] ? $element_consultation["type_consultation"]["prix"] : ""}}</td>
                                {{$element_consultation["type_consultation"]["prix"] ? $montant = $montant + $element_consultation["type_consultation"]["prix"] : ""}}
