            ...
            <section  style="margin-top : 30px">
                <table>
                    ...
                    <!-- <tr>
                        ...
                        {{$montant = 0}}
                        @foreach($element_dentaires as $element_dentaire )
                            <tr>
                                <td style="padding-left: 15px;">{{$element_dentaire["type_dentaire"]["nom"] ? $element_dentaire["type_dentaire"]["nom"] : "" }}</td>
                                <td style="padding-left: 15px;">{{$element_dentaire["type_dentaire"]["prix"] ? $element_dentaire["type_dentaire"]["prix"] : ""}}</td>
                                {{$element_dentaire["type_dentaire"]["prix"] ? $montant = $montant + $element_dentaire["type_dentaire"]["prix"] : ""}}
