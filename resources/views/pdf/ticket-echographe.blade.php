            ...
            <section  style="margin-top : 30px">
                <table>
                    ...
                    <!-- <tr>
                        ...
                        {{$montant = 0}}
                        @foreach($element_echographes as $element_echographe )
                            <tr>
                                <td style="padding-left: 15px;">{{$element_echographe["type_echographe"]["nom"] ? $element_echographe["type_echographe"]["nom"] : "" }}</td>
                                <td style="padding-left: 15px;">{{$element_echographe["type_echographe"]["prix"] ? $element_echographe["type_echographe"]["prix"] : ""}}</td>
                                {{$element_echographe["type_echographe"]["prix"] ? $montant = $montant + $element_echographe["type_echographe"]["prix"] : ""}}
