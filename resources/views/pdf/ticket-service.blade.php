                    ...
                    <!-- <tr>
                        ...
                        @foreach($element_services as $element_service )
                            <tr>
                                ...
                                {{$element_service["type_service"]["prix"] ? $mnt = $mnt + $element_service["type_service"]["prix"] : ""}}
            ...
            <section  style="overflow: hidden;margin-bottom : 20px;font-size: 20px;">
                <table>
                    ...
                    <tr>
                        ...
                        <td style="padding : 10px 0;text-align:left">  {{\App\Models\Outil::formatPrixToMonetaire($mnt, false, true)}}</td>
                    </tr>
                    </tbody>
                </table>
            </section> 
