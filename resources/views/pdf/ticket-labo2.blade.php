            ...
            <section  style="margin-top : 30px">
                <table>
                    ...
                    <!-- <tr>
                        ...
                        {{$montant = 0}}
                        @foreach($element_labo2s as $element_labo2 )
                            <tr>
                                <td style="padding-left: 15px;">{{$element_labo2["type_labo2"]["nom"] ? $element_labo2["type_labo2"]["nom"] : "" }}</td>
                                <td style="padding-left: 15px;">{{$element_labo2["type_labo2"]["prix"] ? $element_labo2["type_labo2"]["prix"] : ""}}</td>
                                {{$element_labo2["type_labo2"]["prix"] ? $montant = $montant + $element_labo2["type_labo2"]["prix"] : ""}}
