            ...
            <section  style="margin-top : 30px">
                <table>
                    ...
                    <!-- <tr>
                        ...
                        {{$montant = 0}}
                        @foreach($element_labos as $element_labo )
                            <tr>
                                <td style="padding-left: 15px;">{{$element_labo["type_labo"]["nom"] ? $element_labo["type_labo"]["nom"] : "" }}</td>
                                <td style="padding-left: 15px;">{{$element_labo["type_labo"]["prix"] ? $element_labo["type_labo"]["prix"] : ""}}</td>
                                {{$element_labo["type_labo"]["prix"] ? $montant = $montant + $element_labo["type_labo"]["prix"] : ""}}
